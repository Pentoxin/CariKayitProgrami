...
{
    public partial class Main_EN : Page
    {
        public Main_EN()
        {
            InitializeComponent();
        ...
        {
            dataGrid.ItemsSource = GetBusinesses(Main_TR.ConnectionString);
        ...
        private void Updatebutton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                Main_EN.selectedBusiness = (Business)dataGrid.SelectedItem;

                var deneme = dataGrid.SelectedItem;
                if (selectedBusiness == null)
                {
                    ...
                    if (saveFileDialog.ShowDialog() == true)
                    {
                        ...
                        if (Yazdir_TR.degiskenler.olustur == true)
                        {
                            ...
                            if (File.Exists(fontPath))
                            {
                                ...
                                var writer2 = new PdfWriter(Main_TR.PDFPath2);
                                ...
                                {
                                    Process.Start(new ProcessStartInfo(Main_TR.PDFPath2) { UseShellExecute = true });
                                }
                            }
                            else
                            {
        ...
        private void DilComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                // Seçilen öğeyi al
                Main_TR.selectedValue = DilComboBox.SelectedIndex;
